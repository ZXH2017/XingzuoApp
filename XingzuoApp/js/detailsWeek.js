$(function() {
	...
	$.ajax({ //数据的获取
		...
		success: function(data) {
			...
			//console.log(data.showapi_res_body.week.summary_star)
			...
			switch(data.showapi_res_body.week.summary_star) {
				case 1:
			...
			$(".info2:eq(0)").html(data.showapi_res_body.week.lucky_num);
			$(".info3:eq(0)").html(data.showapi_res_body.week.grxz);
			$(".info4:eq(0)").html(data.showapi_res_body.week.week_notice);
			$(".info5:eq(0)").html(data.showapi_res_body.week.love_txt);
			$(".info6:eq(0)").html(data.showapi_res_body.week.work_txt);
			$(".info7:eq(0)").html(data.showapi_res_body.week.money_txt);
